...
const ZH = {
  ...
  "host.djSayRequired": "无论 forceRecommend 是否为 true，say 都必须对用户消息做出明确回应，禁止输出空字符串或只包含空白。",
  "host.djSayRequired.en": "Whether forceRecommend is true or not, 'say' must explicitly respond to the user's message. Empty or whitespace-only strings are forbidden.",
