...
const ZH = {
  ...
  "host.djForceRecommend": "当 forceRecommend=true 时，必须推荐 3-5 首歌（play 长度 3-5）。segue 是一段电台主播口播推荐语（100-200字），以情感、氛围、意境来描写将要播放的音乐，不要在 segue 中提及任何歌曲名或歌手名。像真实电台 DJ 一样，用一句一句口语化的表达来跟听众聊天，语气自然亲切、有感染力，可以涉及情绪共鸣、场景画面、回忆联想等，但不要出现具体歌单信息。",
  "host.djForceRecommend.en": "When forceRecommend=true, recommend 3-5 songs (play length 3-5). segue is a radio host spoken recommendation (100-200 words), describing the upcoming music through emotion, atmosphere, and imagery. Do NOT mention any song names or artist names in segue. Speak like a real radio DJ in conversational sentences, with warmth and emotional resonance — evoke moods, scenes, memories — but never reveal the actual playlist.",
  "host.djExplicitRecommend": "当 forceRecommend=false 且用户明确表示要推荐/要歌单/要新歌/要听歌时：直接推荐 3-5 首歌（play 长度 3-5），confirmRecommend=false。segue 是一段电台主播口播推荐语（100-200字），以情感、氛围、意境描写音乐，不要提及歌曲名或歌手名，用口语化的一句一句来跟听众聊天。",
  "host.djExplicitRecommend.en": "When forceRecommend=false and the user explicitly requests recommendations: recommend 3-5 songs (play length 3-5), confirmRecommend=false. segue is a radio host spoken recommendation (100-200 words), describing music through emotion, atmosphere, imagery. Do NOT mention song or artist names. Speak in conversational sentences like a real radio DJ.",
  ...
  "host.nextBatch.recommendHint": "推荐 3-5 首歌（play 长度 3-5），segue 是一段电台主播口播推荐语（100-200字），以情感氛围描写音乐，不要提及歌曲名或歌手名，用口语化的句子自然衔接上段内容，风格延续但歌曲不要重复。",
  "host.nextBatch.recommendHint.en": "Recommend 3-5 songs (play length 3-5). segue is a radio host spoken recommendation (100-200 words), describing music through emotion and atmosphere. Do NOT mention song or artist names. Speak conversationally, naturally connecting to the previous segment. Style continues but songs must not repeat.",
  ...
  "host.mimo.requiredFields": "say, play, segue, memory 是必须字段。play 至少3首。segue 100-200字。memory 至少1条。",
  "host.mimo.requiredFields.en": "say, play, segue, and memory are required fields. play must have at least 3 songs. segue 100-200 words. memory must have at least 1 entry.",
